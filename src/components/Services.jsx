          ...
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden">
              ...
              >
                ...
                <p className="body-2 mb-[3rem] text-n-3">
                  Automatically enhance your photos using our AI app&apos;s phot
              ...
              <div className="py-12 px-4 xl:px-8">
                ...
                <ul className="flex items-center justify-between"> 
                    {brainwaveServicesIcons.map((item, idx) => 
                        <li className={`rounded-2xl flex items-center justify-center ${
                            idx === 2 ? 
                            'w-[3rem] h-[3rem] p-0.25 bg-conic-gradient rounded-2xl md:w-[4.5rem] md:h-[4.5rem]' : 
                            'flex w-10 h-10 bg-n-6 md:w-15 md:h-15'}`} key={idx} >
                            <div className={idx === 2 ?
